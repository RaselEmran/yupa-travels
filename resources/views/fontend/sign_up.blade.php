...
<div class="bg2 overlay" style="background-image: url(https://yupa.asia/public/fontend/images/bg7.jpg);">
    <div class="container">
        <div class="row">
								 ...
								 <div class="row input-space">
									...
									<div class="row input-space">
										<div class="col-md-12">
											<div class="inner-addon right-addon">
												...
												<input type="password" id="password" class="password form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="Password" />
											</div>
										...
										<div class="col-md-12">
											<div class="inner-addon right-addon">
												<i class="glyphicon glyphicon-lock"></i>
												 <input id="password-confirm" type="password" class="password form-control" name="password_confirmation" placeholder="Confirm Password" required>
											</div>
									...
									<div class="row input-space">
										...
										<div class="col-md-6 text-right">
											<a id="show-password" onclick="showPass('show')">Show Password</a>
											<a id="hide-password" style="display: none;" onclick="showPass('hide')">Hide Password</a>
										</div>
									</div>
									<div class="row input-space">
										<div class="col-md-12">
