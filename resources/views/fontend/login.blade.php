...
<div class="bg2 overlay" style="background-image: url(https://yupa.asia/public/fontend/images/bg6.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6 text-center">
                <h2><strong>Login with YuPa</strong></h2>
								...
								@csrf
									...
									<div class="row">
										...
										<div>
											...
											<p>Don't have an account? <a href="{{ route('sign-up') }}" id="sign-up-link"> Sign up</a></p>
