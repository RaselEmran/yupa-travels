...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Amenity Upadte
    ...
    <div class="panel-body">
        <form role="form" action="{{ route('admin.amenity.update') }}" method="post" enctype="multipart/form-data" id="addForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <span class="text-muted">For Icon: <span class="btn btn-xs btn-link" data-toggle="modal" data-target="#modal_remote">Clic Here</span></span>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary"  id="submit">Upadte Amenity<i class="icon-arrow-right14 position-right"></i></button>
